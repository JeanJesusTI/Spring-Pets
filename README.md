...
<ul>
    <li> Após iniciar a aplicação, podemos acessar o Swagger (http://localhost:8080/swagger-ui.html#/) ou uma API-Cliente como PostMan, Insomnia e etc, para ter acesso aos principais serviços da aplicação Porém a princípio, porém será necessário a autenticação dos usuário por meio do JWT</b></li>
</ul>
<br/>
<p align="center">
